	...
	render(){
		return(
			<React.Fragment>
				...
				<InputRange attr={"d"} minimum={1} maximum={10} value={this.config.d} step={1} label={"Neightborhood distance"} ttip={"Set the distance of the Moore neightborhood. Higher values will make the algorithm more resource-intensive."} cb={this.updateConfig}/>
